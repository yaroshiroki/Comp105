...
testCases :: [Test]
testCases = 
    [ oneArg (Main.is_wall maze2) (0, 0) True  "is_wall maze2"
    , oneArg (Main.place_player maze2) (1, 1) maze2' "place_player maze2"
    , twoArg Main.move (1, 1) 'w' (1, 0) "move"
    , twoArg (Main.can_move maze2) (1, 1) 's' True "can_move maze2"
    , twoArg (Main.get_path maze2) (1, 1) (3, 3) [(1,1),(2,1),(3,1),(3,2),(3,3)] "get_path maze2"
    ]
