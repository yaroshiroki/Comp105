...
testCases :: [Test]
testCases = [
    oneArg Assignment1.char_to_int    '1'          1           "char_to_int",
    twoArg Assignment1.repeat_char    'a' 3        "aaa"       "repeat_char",
    oneArg Assignment1.decode         "a1b2"       "abb"       "decode",
    oneArg Assignment1.int_to_char    1            '1'         "int_to_char",
    twoArg Assignment1.length_char    'a' "aaab"   3           "length_char",
